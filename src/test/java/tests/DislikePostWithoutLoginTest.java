...
public class DislikePostWithoutLoginTest extends BaseTest {

    @Test
    public void dislikeWithoutLoginTest() {
        ...
        System.out.println("4. Click the Dislike button");
        postModal.clickDislikeBtn();
